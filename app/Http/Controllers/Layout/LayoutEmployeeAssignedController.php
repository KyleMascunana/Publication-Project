...
class LayoutEmployeeAssignedController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('artist.employeeassigned.index', compact('employeeassigned'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        return view('artist.employeeassigned.create', compact('manuscripts', 'users', 'employees'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return to_route('artist.employeeassigned.index')->with('message', 'Manuscript has been sent to be reviewed!');
    }
