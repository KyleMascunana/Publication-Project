...
class CopyController extends Controller
{
    public function index()
    {
        ...
        $roles = Role::all();
        $users = User::all();
        return view('copyeditor.employees.index', compact('users', 'roles', 'employees'));
    }

    public function create()
    {
        return view('copyeditor.employees.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return to_route('copyeditor.employees.index')->with('message', 'Layout Artist Infromation has been Updated Successfully!');
    }
