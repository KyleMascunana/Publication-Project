...
class AcceptedManuscriptController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('chief.acceptedmanuscript.index', compact('acceptedmanuscripts'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        return view('chief.acceptedmanuscript.create', compact('employees', 'reviewedstatus', 'manuscripts', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return to_route('chief.acceptedmanuscript.index')->with('message', 'Manuscript "STATUS" has been Updated Successfully!');
    }
    ...
    public function show($id)
    {
        ...
        return view('chief.acceptedmanuscript.view')->with('data', $data);
    ...
    public function edit($id)
    {
        ...
        return view('chief.acceptedmanuscript.edit', compact('acceptedmanuscript'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('chief.acceptedmanuscript.index')->with('message', 'Accepted Manuscript has been Updated Successfully!');
    }
    /**
