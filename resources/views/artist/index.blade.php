        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    {{ __("Layout Artist Content") }}
                </div>
                <div class="container col-xl-10 col-xxl-8 px-6 py-3">
                    <div class="row align-items-center g-lg-5 py-5">
                      <div class="col-lg-7 text-center text-lg-start">
                      <span class="border border-warning border border-5">
                        <h3 class="display-6 lh-2 mb-2">A Publication of the Mindanao State University - Naawan</h3>
                        <p class="col-lg-10 text-secondary fs-7">The <b>Journal of Environment and Aquatic Resources</b> is an open access peer-reviewed
