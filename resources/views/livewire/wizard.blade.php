            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="title">Manuscript Type:</label>
                        <input type="text" wire:model="manu_type" class="form-control" id="taskTitle">
                        @error('name') <span class="error">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="description">Manuscript Title:</label>
                        <input type="text" wire:model="manu_title" class="form-control" id="productAmount"/>
                        @error('amount') <span class="error">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="description">File Type:</label>
                        <textarea type="text" wire:model="manu_file_type" class="form-control" id="taskDescription">{{{ $description ?? '' }}}</textarea>
