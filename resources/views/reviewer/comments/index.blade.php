<x-reviewer-layout>
    <div class="py-12 w-70">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('reviewer.comments.create') }}"
                                ...
                                <div class="card text-center">
                                    <div class="card-header">
                                        ...
                                        <div class="flex space-x-5 justify-end text-xs">
                                                <a href="{{ route('reviewer.comments.view', $comment->id) }}"
                                                    class="px-4 py-2 bg-yellow-700 hover:bg-yellow-600 text-white rounded-md">View</a>

                                                <a href="{{ route('reviewer.comments.downloadz', $comment->file) }}"
                                        ...
                                        <div class="text-gray-500 text-md space-x-5 flex">
                                            <p><i class="fa-solid fa-cloud fa-beat pr-2"></i>Manuscript Status:
                                                <span class="pl-2">{{ $comment->com_status }}</span> </p>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                       <div>
