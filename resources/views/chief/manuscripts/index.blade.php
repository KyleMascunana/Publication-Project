                                ...
                                <div class="card text-center">
                                    <div class="card-header">
                                        ...
                                        <div class="flex space-x-5 justify-end text-xs">
                                            <a href="{{ route('chief.manuscripts.view', $manuscript->id) }}"
                                                class="px-3 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-md"> View</a>

                                            <a href="{{ route('chief.manuscripts.download', $manuscript->file) }}"
                                                class="px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md"> Download</a>
        ...
        <div class="modal-body">
            <table class="min-w-full divide-y devide-gray-200 ">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($authormanuscripts as $papa)
                    <tr>
