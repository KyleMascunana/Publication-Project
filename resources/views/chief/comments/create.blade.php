        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-2">
                ...
                <div class="flex justify-end p-3">
                    <a href="{{ route('chief.comments.index') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-white rounded-md"><i class="fa-solid fa-arrow-left text-white"></i>    Go back</a>
                </div>

                <div class="flex flex-col">
                    <div class="space-y-8 divide-y divide-gray-200 mt-10">
                        <form  method="POST" action="{{ route('chief.comments.store') }}" class="row g-3" enctype="multipart/form-data">
                            @csrf
