    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg lg:rounded-lg p-2">
                <span class="text-xl px-4 py-2">Manuscript Status Update/Edit Panel</span>
                <div class="flex justify-end p-3">
                    <a href="{{ route('chief.acceptedmanuscript.index') }}"
                ...
                <div class="flex flex-col p-2 rounded-md">
                        ...
                        <form method="POST" action="{{ route('chief.acceptedmanuscript.update', $acceptedmanuscript->id) }}">
                            @csrf

                            @method('PUT')
                            <div class="col-md-8">
                                <label for="inputFirstname" class="form-label px-6 pt-3 text-left text-xs
                                font-medium text-gray-500 uppercase tracking-wider">Manuscript Status Update/Edit  | ID No.({{ $acceptedmanuscript->id }})</label>
