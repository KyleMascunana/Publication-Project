                    ...
                    <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                        ...
                        <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto text-xl">
                            <x-admin-link :href="route('admin.index')" :active="request()->routeIs('admin.index')">
                                <i class="fa-solid fa-computer text-white pr-3"></i>     {{ __('Admin Dashboard') }}
                            </x-admin-link>
                            ...
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    ...
                                    <button class="inline-flex items-center px-3 py-2 border border-0 text-sm leading-4 font-medium rounded-md text-white bg-gray-900 hover:text-white-700 focus:outline-none transition ease-in-out duration-150">
                                        <div> <i class="fa-solid fa-users text-white pr-3"></i>   {{ __('Users') }}</div>
                                ...
                                <x-slot name="content">
                                    <x-admin-dropdown-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.index')">
                                        <i class="fa-solid fa-users text-red-500 pr-3"></i>     {{ __('Manage Users') }}
                                    </x-admin-dropdown-link>
                                    <hr class="pb-2 mt-2">
                                    <x-admin-dropdown-link :href="route('admin.roles.index')" :active="request()->routeIs('admin.roles.index')">
                                        <i class="fa-solid fa-cog text-red-500 pr-3"></i>     {{ __('Manage Roles') }}
                                    </x-admin-dropdown-link>
                                    <hr class="pb-2 mt-2">
                                    <x-admin-dropdown-link :href="route('admin.permissions.index')" :active="request()->routeIs('admin.permissions.index')">
                                        <i class="fa-solid fa-shield text-red-500 pr-3"></i>     {{ __('Manage Permission') }}
                                    </x-admin-dropdown-link>
                                    <hr class="pb-2 mt-2">
                                    <x-admin-dropdown-link :href="route('admin.details.index')" :active="request()->routeIs('admin.details.index')">
                                        <i class="fa-solid fa-user-secret text-red-500 pr-3"></i>     {{ __('User Information') }}
                                    </x-admin-dropdown-link>
                                    <hr class="pb-2 mt-2">
                                    <x-admin-dropdown-link :href="route('admin.employees.index')" :active="request()->routeIs('admin.employees.index')">
                                        <i class="fa-solid fa-user-tie text-red-500 pr-3"></i>     {{ __('Manage Employees') }}
                                    </x-admin-dropdown-link>
                        ...
                        <nav class="bg-gray-900">
                            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                              <div class="relative flex h-16 items-center justify-end">
                                ...
                                <x-admin-link :href="route('admin.activity.index')" :active="request()->routeIs('admin.activity.index')">
                                    <i class="fa-solid fa-chart-simple text-white pr-3 pb-3 items-center"></i>    {{ __('Activity Logs') }}
                                </x-admin-link>
