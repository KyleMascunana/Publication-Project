        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endrole
                    @role('chief')
                    <x-nav-link :href="route('chief.index')" :active="request()->routeIs('chief.index')">
                        {{ __('Editor in Chief') }}
                    </x-nav-link>
                    @endrole
                    @role('author')
                    ...
                    @endrole
                    @role('reviewer')
                    <x-nav-link :href="route('reviewer.index')" :active="request()->routeIs('reviewer.index')">
                        {{ __('Reviewer') }}
                    </x-nav-link>
                    @endrole
                    @role('layout')
                    ...
                    @endrole
                    @role('copy')
                    <x-nav-link :href="route('copyeditor.index')" :active="request()->routeIs('copyeditor.index')">
                        {{ __('Copy Editor') }}
                    </x-nav-link>
                    @endrole
                </div>
